 ...
 * the `net.trilleo.mc.plugins.tritown.items` package (or a subpackage). The item is
...
abstract class PluginItem(val id: String) {
    ...
    companion object {
         ...
         *
         * Namespace `tritown`, key `custom_item_id`.
         */
        @JvmField
        val ITEM_ID_KEY: NamespacedKey = NamespacedKey.fromString("tritown:custom_item_id")!!
    }
     ...
     *
     * Use the [net.trilleo.mc.plugins.tritown.utils.itemStack] DSL for concise item
